...
# 1. Remove the Continue Watching inside the if check
old_continue = """        if (selectedCategory == animeStr) {if (animeHistoryItems.isNotEmpty()) {
...
new_continue = """        if (selectedCategory == animeStr) {"""

content = content.replace(old_continue, new_continue)

# 2. Add Continue Watching OUTSIDE the category checks, right above the HeroCarousel or below it.
# In HomeScreen, it's right under Categories Tab Row. Let's put it right under Categories Tab Row.
